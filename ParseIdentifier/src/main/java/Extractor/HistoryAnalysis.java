...
public class HistoryAnalysis {
    public static void main(String[] args) throws Exception {
        //读取项目的信息
        //ProjectCommit("dubbo");//done
//        ProjectCommit("zeppelin");
//        ProjectCommit("jmeter");
        //ProjectCommit("tomcat");//done
        //ProjectCommit("storm");//done
        // ProjectCommit("cassandra");//done
        //ProjectCommit("hbase");
        //ProjectCommit("beam");
        ProjectCommit("hbase");
        //ProjectCommit("camel");//
    ...
    public static void ProjectCommit(String projectname) throws Exception {
        ...
        String projectpath = "C:\\project\\IdentifierStyle\\data\\GitProject\\Apache\\" + projectname + "\\";
        String FileIndex = "C:\\project\\IdentifierStyle\\data\\JavaFileIndex\\" + projectname + ".txt";
        //以下是程序的输出文件
        String LogOutput = "C:\\project\\IdentifierStyle\\log\\log_output_hibernate-reactive.txt";
